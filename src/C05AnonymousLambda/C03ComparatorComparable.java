...
//        // java 에서는 비교를 위한 인터페이스가 대표적으로 2개가 제공된다.
...
//        String a = "hello";
//        String b = "world";
//        System.out.println(a.compareTo(b)); // 마이너스 값
//
...
//
//        // 직접 Student를 List에 담아 저장
//        List<Student> studentList = new ArrayList<>();
//        studentList.add(new Student("Kim", 14));
//        studentList.add(new Student("Lee", 32));
//        studentList.add(new Student("Choi", 22));
//        studentList.add(new Student("Jo", 43));
//
...
//
//        // 정렬 방법 2. Comparator를 구현한 익명 객체를 사용
...
//        System.out.println(Arrays.toString(stArr));
        ...
        // 정렬 : 리스트안의 배열의 index 1번째 값을 기준으로 오름차순
