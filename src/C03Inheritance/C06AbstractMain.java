...
//public class C06AbstractMain extends FinalParents { // final 키워드가 붙은 클래스는 상속 불가
// final 키워드가 붙은 메서드는 오버라이드 불가
...
//        a1.makeSound2();
        ...
        // 실질적인 실체가 dog클래스를 통해 만들어지므로, 여기서는 d2의 makesound2를 사용가능
...
abstract class AbstractAnimal {
    ...
    // 메서드를 선언만 하고 구현이 없는 메서드 사용 시 abstract키워드 사용
